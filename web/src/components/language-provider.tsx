...
export const bn: Record<string, string> = {
  ...
  "A place of worship, learning and community.":
    "\u0987\u09ac\u09be\u09a6\u09a4, \u09b6\u09bf\u0995\u09cd\u09b7\u09be \u0993 \u09b8\u09ae\u09cd\u09aa\u09cd\u09b0\u09a6\u09be\u09af\u09bc\u09c7\u09b0 \u098f\u0995\u099f\u09bf \u09b8\u09cd\u09a5\u09be\u09a8\u0964",
  "HOW WE SERVE":
  ...
  "GIVE WITH PURPOSE":
    "\u0989\u09a6\u09cd\u09a6\u09c7\u09b6\u09cd\u09af\u09aa\u09c2\u09b0\u09cd\u09a3 \u09a6\u09be\u09a8",
  "Support your mosque.":
    "\u0986\u09aa\u09a8\u09be\u09b0 \u09ae\u09b8\u099c\u09bf\u09a6\u0995\u09c7 \u09b8\u09b9\u09be\u09af\u09bc\u09a4\u09be \u0995\u09b0\u09c1\u09a8\u0964",
  "Choose a donation amount":
    "\u09a6\u09be\u09a8\u09c7\u09b0 \u09aa\u09b0\u09bf\u09ae\u09be\u09a3 \u09ac\u09c7\u099b\u09c7 \u09a8\u09bf\u09a8",
  "Our Story": "\u09a6\u09c7\u09b6\u09cd\u09af\u09be\u09a8\u09c0",
  "History & Milestones":
    "\u09a4\u09bf\u09b0\u09c1\u09a8\u09c0\u09a4\u09c0 \u0993 \u09aa\u09cd\u09b0\u09be\u09b7\u09b0",
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="w-[min(92%,420px)] rounded-lg bg-white p-6 text-center shadow-lg">
            ...
            <p className="mb-6 text-sm text-gray-600">
              Please select English or বাংলা to continue.
            </p>
            <div className="flex gap-3 justify-center">
              <button
                onClick={() => choose("bn")}
                className="rounded-md bg-[#073a2d] px-4 py-2 text-white"
              >
                বাংলা
              </button>
              <button
