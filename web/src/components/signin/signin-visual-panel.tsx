...
import { CheckIcon } from "@/components/signup/icons";

const highlights = [
  "Your saved prayer reminders",
  "Events you registered for",
  "Your community profile",
];

/**
 * Static visual half of the sign in screen — no client JavaScript.
 * Desktop: sticky column beside the form. Mobile: compact banner above it.
 * Shares the auth-* styling with sign up, but carries its own returning-visitor copy.
 */
export function SigninVisualPanel() {
  return (
    <aside className="auth-panel-wash relative isolate flex min-h-60 flex-col justify-between overflow-hidden rounded-xl px-5 pb-8 pt-10 text-white sm:min-h-72 sm:px-8 sm:pb-10 lg:sticky lg:top-28 lg:min-h-140 lg:px-10 lg:py-12">
      ...
      <div className="relative z-10 max-w-md">
        ...
        <p className="mt-4 hidden text-[15px] leading-7 text-white/75 sm:block">
          Sign in to pick up where you left off — prayer reminders, event
          registrations and everything else your mosque keeps for you.
        </p>
      </div>
